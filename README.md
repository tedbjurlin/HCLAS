...
Full instructions: https://srid.ca/CLAS/start
...
- Run the application without installing: `nix run github:tedbjurlin/CLAS` (or `nix run .` from checkout)
- Common workflows
  - Adding library dependencies in Nix: https://zero-to-flakes.com/haskell-flake/dependency
  - Adding tests: https://srid.ca/CLAS/tests
